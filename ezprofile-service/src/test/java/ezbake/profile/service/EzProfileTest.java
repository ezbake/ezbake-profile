...
public class EzProfileTest {
    ...
    public static final int REDIS_PORT = randomPort(22456, 23958);
	...
	public static void init() throws Exception {
        ...
        ezConfig.setProperty(EzBakePropertyConstants.REDIS_PORT, Integer.toString(REDIS_PORT));
        ezConfig.setProperty(EzBakePropertyConstants.REDIS_HOST, InetAddress.getLocalHost().getCanonicalHostName());
		...
		serverPool.startCommonService(new EzSecurityHandler(), ezsecurityConstants.SERVICE_NAME, new EzBakeApplicationConfigurationHelper(ezConfig).getSecurityID());
        serverPool.startCommonService(new EzLocksmithHandler(), EzLocksmithConstants.SERVICE_NAME, new EzBakeApplicationConfigurationHelper(ezConfig).getSecurityID());
    ...
    public void setUp() throws UnknownHostException {
        Jedis jedis = new Jedis(InetAddress.getLocalHost().getCanonicalHostName(), REDIS_PORT);
        jedis.flushAll();
        jedis.close();
